function ashleyNeuropixel(Animal,reload)
...
[ridgeVals, dimBeta] = ridgeMML(spikeTrace, fullR, true); %make model fit
...
%% nested functions
    function dataR = makeDesignMat(data)
        ...
        [dMat, traceOut] = Widefield_analogToDesign(temp, prctile(temp,60), 1, sRate, sRate, motorIdx, 0);
...
%         [dMat, ~] = Widefield_analogToDesign(traceOut, prctile(traceOut,75), 1, sRate, sRate, motorIdx, 0);
