...
spikes_repo_dir = 'C:\Users\Xiaonan Richard Sun\GitHub\spikes';
npymatlab_repo_dir = 'C:\Users\Xiaonan Richard Sun\GitHub\npy-matlab';

addpath(genpath(spikes_repo_dir));
addpath(genpath(npymatlab_repo_dir));


%% set paths for where to find your data

myKsDir = 'G:\simon_ephys\Optotest4\_spikeglx_ephysData_probe00_g1';
...
eventTimes = eventTimes{1}{2}(diff(eventTimes{1}{2})>1);
