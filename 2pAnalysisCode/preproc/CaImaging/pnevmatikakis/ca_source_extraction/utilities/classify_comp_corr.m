...
%    A_thresh:  threshold for determining spatial overlap (default: 0.1)
%    Npeaks:       number of high activity intervals for each component (default: 10)
...
% Written by Eftychios A. Pnevmatikakis, Simons Foundation, 2016, with inputs from Farzaneh Najafi and Matt Kaufman
...
if ~isfield(options,'Npeaks') || isempty(options.Npeaks); Np = defoptions.Npeaks; else Np = options.Npeaks; end
