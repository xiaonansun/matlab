...
lrDir = fullfile(S.dir.imagingRootDir,animal,'imaging',session,'logisticRegression'); % directory to save the current logistic regression analysis data and figures
