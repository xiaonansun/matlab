function [perf,error,tCount] = computeBehavior(bhv,maxCount,varargin)
...
% performance between 0 and 1 and an error term which is the 95% confidence
% interval assuming a binomial distribution. Also returns the absolute
% amount of included trials.
%
% Usage: [perf,error,tCount] = selectBehavior(bhv,varargin)
% 
% 'bhv' is a behvaioral structure that is
% created from Bpod and containts two field
% 'Rewarded' and 'Punished' that are used to
% compute performance.
