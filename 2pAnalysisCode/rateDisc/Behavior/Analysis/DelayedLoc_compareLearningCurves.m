...
modId = [2 4 1]; %id for modalities. Default is audio, somatosensory and audiosomatosensory
...
for iFiles = 1:size(Files,1)
    ...
    useData = length(SessionData.Rewarded) > 100; % if file contains at least 100 trials and different distractor rates
