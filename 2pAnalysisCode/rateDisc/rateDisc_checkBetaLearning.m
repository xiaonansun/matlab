% function rateDisc_checkBetaLearning
% code to assess the beta kernels for all animals of a given group.
...
for iAnimals = 1 : 8
    ...
    % load variance
    [~, ~, sessionVar, ~, ~, recs] = rateDisc_plotAreaSVD(cPath, cAnimal, lastRec, false);
    varRecs = recs;
    allVar{iAnimals} = sessionVar;
    
    clear regBeta regMeans
