...
% 
% Convert Suite2P's dat data structure to something easier to use. A is the
% spatial footprints of the neurons, pixels x neurons. S is the inferred
% "spikes", neurons x time. neuropilCoeffs is the scaling coefficient for
% the neuropil. kernels is the calcium convolution kernel. recon is the
% reconstructed traces for the neurons, obtained by re-convolving the
